...
const CASES = [
	...
	},
	{
		...
		want: "accept",
		candidate: {
			title: "Tobacco-curing barn in Cao Bang, Vietnam",
			description: "A tobacco curing barn with leaves hanging inside to dry",
			tags: "barns tobacco Vietnam",
			date: "2012",
			width: 2400,
			height: 1600,
		},
	},
	{
		...
		want: "accept",
		candidate: {
			title: "Tobacco field in bloom, Vietnam",
			description: "Rows of Nicotiana tabacum growing on a farm in Vietnam, green leaves in the afternoon",
			tags: "tobacco field farm crop vietnam",
			date: "2021",
			width: 2000,
			height: 1333,
		},
	...
	{
		name: "nhà sấy đẹp nhưng không ở Việt Nam",
		slot: "stage-4",
		want: "reject",
		candidate: {
			title: "Tobacco curing barn in Kentucky",
			description: "Golden leaf hanging to cure inside a working barn",
			tags: "tobacco curing barn",
			date: "2021",
			width: 2400,
			height: 1600,
		},
	...
	},
	{
		...
		want: "accept",
		candidate: {
			title: "Containers stacked at Hai Phong port terminal, Vietnam",
			description: "Shipping containers being loaded by a crane at a container terminal in Vietnam",
			tags: "port container terminal crane vietnam",
			date: "2016",
			width: 2400,
			height: 1400,
		},
